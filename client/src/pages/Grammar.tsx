...
const CASES: CaseData[] = [
  ...
  },
  {
    ...
    prepositions: [
      ...
      { word: 'už', meaning: 'behind / beyond (location)', example: 'Namas yra už miško.', exampleEn: 'The house is behind the forest.' },
  ...
  },
  {
    ...
    prepositions: [
      ...
      { word: 'prieš', meaning: 'before (time) / against / ago / in front of (position)', example: 'Atvykau prieš savaitę. / Stoviu prieš namą.', exampleEn: 'I arrived a week ago. / I am standing in front of the house.' },
  ...
  },
  {
    ...
    usage: [
      ...
      'Po "su" (with someone/something): einu su draugu',
      'Tapti / dirbti kuo (becoming or working as): Jis tapo mokytoju.',
      'Veiksmažodžiai su -tis: domėtis, rūpintis, džiaugtis + įnagininkas',
    ],
    examples: [
    ...
    prepositions: [
      ...
      { word: 'ties', meaning: 'at / right by / level with (exact point)', example: 'Sustokite ties raudonuoju namu.', exampleEn: 'Stop right by the red house.' },
    ],
    endings: {
